...
function TransactionInProgress() {
  ...
  return (
    <>
      <div style={{ width: "100vw", height: "100vh", backgroundColor: "var(--tadarab-light-bg)", color:"var(--dark-black)" }} className="d-flex align-items-center justify-content-center position-relative">
