...
// import {showHidePasswordHandler} from "./utils";
        ...
        <Col xs={{span:12 , order:2}} sm={{span:6 , order:1}} className={styles["register__register-box"]}>
          ...
          <div className={styles["register__register-box__registeration-form-box"]}>
              <Form>
                  ...
                  <div className={styles["register__register-box__registeration-form-box__name-field-container"]}>
                    ...
                    <Form.Control type="text" placeholder="الاسم" className={styles["register__register-box__registeration-form-box__name-field"]}/>
                  </div>

                  <div className={styles["register__register-box__registeration-form-box__email-field-container"]}>
                    <div className={styles["register__register-box__registeration-form-box__icon-wrapper"]}>
                    ...
                    <Form.Control type="email" placeholder="البريد الالكتروني" className={styles["register__register-box__registeration-form-box__email-field"]}/>
                  </div>
                  ...
                  <div className={styles["register__register-box__registeration-form-box__phone-field-container"]}>
                   ...
                   <DropdownButton
                    ...
                    className={styles["register__register-box__registeration-form-box__country-code-dropdown"]}
                    >
                  ...
                  <div className={styles["register__register-box__registeration-form-box__password-field-container"]}>
                    <div className={styles["register__register-box__registeration-form-box__icon-wrapper"]}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.25rem" height="1.438rem" viewBox="0 0 20 22.857">
                  ...
                  <Button className={styles["register__register-box__registeration-form-box__make-new-acc-btn"]}>
                  انشاء حساب جديد
                  </Button>
