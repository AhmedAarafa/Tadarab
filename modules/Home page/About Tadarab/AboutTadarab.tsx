          ...
          <Swiper dir="rtl" slidesPerView={1} navigation={true} pagination={{ "clickable": true }}
            ...
            <div className={styles["about-tadarab__cards-carousel"]}>
              {usersReviews.map((review: any, i: number) => {
                return (
                  <SwiperSlide key={i} className={styles["about-tadarab__cards-carousel__item"]}>
                    <div className={styles["about-tadarab__cards-carousel__item__container"]}>
                      ...
                      <div className={styles["about-tadarab__cards-carousel__item__container__review-box"]}>
                        <div className={styles["about-tadarab__cards-carousel__item__container__review-box__quote"]}>
                          ...
                          <div className={styles["about-tadarab__cards-carousel__item__container__review-box__course-img"]}>
                            <img loading="lazy" src={review.course_image} alt={review.course_title} />
                          </div>
                          <div className={styles["about-tadarab__cards-carousel__item__container__review-box__course-name"]}>
                            <img loading="lazy" src={review.trainer_image} alt={review.trainer_name} />
                            <div>
                              {review.course_title}
                              <div>
