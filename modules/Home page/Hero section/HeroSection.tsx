...
export default function HeroSection() {
  ...
  //   // homePageData?.data?.categories.forEach((cat: any) => {
  //   //   if (
  //   //     cat.slug == "business" ||
  //   //     cat.slug == "family-and-educational-skills"
  //   //   ) {
        ...
        <Col xs={12} sm={{ span: 5, order: 'first' }}>
          <div className={styles["hero-section__container"]}>
            <h1 className={styles["hero-section__title"]}  >
              تعلم أون لاين، أكبر مكتبة دورات عربية
            </h1>
            <p className={styles["hero-section__para"]}>
              استكشف مئات الدورات التدريبية في جميع التخصصات باشتراك واحد.
            </p>
            ...
            <div className={styles["hero-section__chips-box"]}>
              <Link href={`/topic/business`}>
                <span className={styles["hero-section__chip"]}>ريادة الأعمال</span>
              </Link>
              <Link href={`/topic/home`}>
                <span className={styles["hero-section__chip"]}>تنسيق المنزل</span>
              </Link>
              <Link href={`/topic/family-and-educational-skills`}>
                <span className={styles["hero-section__chip"]}>تربية الابناء</span>
              </Link>
              <Link href={`/topic/self-development`}>
                <span className={styles["hero-section__chip"]}>تنمية ذاتية</span>
              </Link>
              <Link href={`/topic/home`}>
                <span className={styles["hero-section__chip"]}>تصميم داخلي</span>
              </Link>
              <Link href={`/topic/talents`}>
                <span className={styles["hero-section__chip"]}>فنون</span>
              </Link>
              <Link href={`/topic/business`}>
                <span className={styles["hero-section__chip"]}>الإستثمار</span>
              </Link>
            </div>
          </div>
        </Col>
