  ...
  return (
    <>
      <div className={styles["course-details__course-card"]} id="sticky-card">
        <h5 id="course-card__title" className={styles["course-details__course-card__title"]}>
        ...
        <div id="course-card__prices-box">
            ...
            <div className={styles["course-details__course-card__price-box"]}>
                <span className={styles["course-details__course-card__price-box__price"]}>1600</span>
                <span className={styles["course-details__course-card__price-box__currency"]}>جنية مصري</span>
            </div>
            <div className={styles["course-details__course-card__old-price-box"]}>
                <div className={styles["course-details__course-card__old-price-box--line-through"]}>
                <span className={styles["course-details__course-card__old-price-box__price"]}>2800</span>
                <span className={styles["course-details__course-card__old-price-box__currency"]}> جنية مصري </span>
                </div>
                <span className={styles["course-details__course-card__old-price-box__discount"]}> (خصم 20%) </span>
            </div>
        </div>
            <div id="course-card__action-btns" className={styles["course-details__course-card__actions-btns"]}>
                <Button className={styles["course-details__course-card__actions-btns__add-to-cart-btn"]}>
                <svg id="add_to_cart" data-name="add to cart" xmlns="http://www.w3.org/2000/svg" width="1.375rem" height="1.2rem" viewBox="0 0 22 20.135">
            ...
            أضف للسلة
                ...
                <Button className={styles["course-details__course-card__actions-btns__fav-btn"]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1.688rem" height="1.5rem" viewBox="0 0 27.429 24">
        ...
        <div id="course-card__guarantee-card" className={styles["course-details__course-card__guarantee-box"]}>
            <div className={styles["course-details__course-card__guarantee-box__icon"]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1.375rem" height="1.5rem" viewBox="0 0 21.603 24">
            ...
            <div className={styles["course-details__course-card__guarantee-box__text-box"]}>
                <div className={styles["course-details__course-card__guarantee-box__text-box__major"]}>
                ٣٠ يوم ضمان ذهبي استرداد كامل المبلغ 
                </div>
                <div className={styles["course-details__course-card__guarantee-box__text-box__minor"]}>
                اذا لم تكن راضي عن محتوى الدورة
                </div>
            </div>
        </div>
        <div id="course-card__details-list" className={styles["course-details__course-card__details-list"]}>
            <div className={styles["course-details__course-card__details-list__item"]}>
                <svg xmlns="http://www.w3.org/2000/svg"  width="1.25rem" height="1.25rem" viewBox="0 0 22 22">
            ...
            <div className={styles["course-details__course-card__details-list__item"]}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="1.25rem" height="1.25rem" viewBox="0 0 22 23.851">
            ...
            <div className={styles["course-details__course-card__details-list__item"]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1.25rem" height="1.25rem" viewBox="0 0 21.254 9.686">
                ...
                <span>
                امتلاك الدورة مدى الحياة
                </span>
            </div>
            <div className={styles["course-details__course-card__details-list__item"]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1.25rem" height="1.25rem" viewBox="0 0 22 15.073">
                ...
                <span>
                المشاهدة من أي موبايل او لابتوب
                </span>
            </div>
            <div className={styles["course-details__course-card__details-list__item"]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1.25rem" height="1.25rem" viewBox="0 0 22 17.962">
                    <g id="certificate" transform="translate(-452.163 -226.188)">
                        ...
                        <path id="certificate-3" d="M457.979,240.166a2.855,2.855,0,1,0-2.855-2.855h0A2.855,2.855,0,0,0,457.979,240.166Z" transform="translate(0.14 -0.68)" fill="#c2121e" opacity="0.4" style={{mixBlendMode: "normal", isolation: "isolate"}}/>
                    </g>
                </svg>
        ...
        <div id="course-card__promo-code" className={styles["course-details__course-card__promo-code"]}>
